...
output:
  ...
  word_document:
    toc: yes
params:
  semester: "Fall Semester of 2021"
  assignment: "Lab 5"
  duedate:    "Friday, October 1st"
  version: 1
  rmarkdown_url: ""
  bib_url: ""
editor_options:
...
plot(euler(as.data.frame.matrix(names.table[,c(1,4,7,10,13)])),quantities=TRUE)
```
...
Answer `r q`:
```{r}
ggplot(iris, aes(x = Sepal.Length, fill = Species)) + geom_density(alpha=0.3) + xlab("Sepal Length") + ggtitle("Sepal Lengths of Irises by Species") + scale_fill_OkabeIto()
```
