...
This wordcloud is only knitted into HTML.
...
The `iris` data comes built into base R, because R is both a programming language and a statistical knowledge base built by statisticians for statisticians. 
